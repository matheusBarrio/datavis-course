// https://observablehq.com/@matheusbarrio/homicidios-em-fortaleza-em-2012@98
...
<main role="main" class="container">
    <div class="row">
      <h3> Homicídios em Fortaleza em 2012 por 100.000 habitantes</h3>
    </div>
  ...
  main.variable(observer("info")).define("info", ["L","homicidesByName","map"], function(L,homicidesByName,map)
{
  // control that shows state info on hover
	...
	infoControl.update = function (feat) {
			this._div.innerHTML = '<h5>Número de homicídios por 100.000 habitantes</h5>' +  (feat ?
...
d3.csv("https://gist.githubusercontent.com/emanueles/8ee225792454a78151d0842a10642a29/raw/9984e32effa99da3cea2ec87a7c9b7b231c71d3c/fortaleza_crimes_populacao.csv").then(function(data) {
    ...
    data.forEach(function(d) {
       bairrosMap.set(d.Bairro,Math.round(+(d.Homicidios/d.Populacao)*100000),-1)
        })
    return bairrosMap
  })
)});
